...
| <a name="input_groups"></a> [groups](#input\_groups) | (Optional) - The group(s) the policy should be applied to | `list(string)` | `null` | no |
...
| <a name="input_roles"></a> [roles](#input\_roles) | (Optional) - The role(s) the policy should be applied to | `list(string)` | `null` | no |
| <a name="input_tags"></a> [tags](#input\_tags) | (Optional) Map of resource tags for the IAM Policy. | `map(string)` | `{}` | no |
| <a name="input_users"></a> [users](#input\_users) | (Optional) - The user(s) the policy should be applied to | `list(string)` | `null` | no |
